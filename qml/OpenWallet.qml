...
Rectangle {
    ...
    Text {
        ...
        color: "#000000"
        text: "If you are new to Deesseel, choose \"Create a new wallet\"."
    ...
    Rectangle {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                color: buttonOpenWallet.down ? "#FFFFFF" : "#000000"
            ...
            background: Rectangle {
                ...
                radius: 6
                color: buttonOpenWallet.down ? "#FFFFFF" : "#444444"
            }
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonCreateWallet.down ? "#FFFFFF" : "#444444"
            }
    ...
    Rectangle {
        ...
        Text {
            ...
            color: !switchImportFrom.checked ? "#000000" : "#cfcfcf"
            text: "from seed"
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.family: "Arial"
                opacity: enabled ? 1.0 : 0.3
                color: buttonImportWallet.down ? "#FFFFFF" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
                elide: Text.ElideRight
            }
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonImportWallet.down ? "#FFFFFF" : "#444444"
            }
