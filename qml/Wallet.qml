    ...
    Rectangle {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                color: buttonBackupKeys.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive XDS"
    ...
    Rectangle {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.bold: true
                opacity: enabled ? 1.0 : 0.3
                color: buttonExportListTransactions.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
            }
    ...
    Rectangle {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.bold: true
                opacity: enabled ? 1.0 : 0.3
                color: buttonSavedAddress.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
            }
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.bold: true
                opacity: enabled ? 1.0 : 0.3
                color: buttonSaveAddress.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
            }
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.bold: true
                opacity: enabled ? 1.0 : 0.3
                color: buttonFullBalance.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
            }
        ...
        Button {
            ...
            contentItem: Text {
                ...
                font.family: "Arial"
                opacity: enabled ? 1.0 : 0.3
                color: buttonSend.down ? "#dddddd" : "#000000"
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
                elide: Text.ElideRight
            }
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " XDS + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
